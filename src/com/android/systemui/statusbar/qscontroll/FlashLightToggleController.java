...
public class FlashLightToggleController extends NotificationToggleController
{

	public final static String TYPE = "FlashLightToggleController";
	public FlashLightToggleController() {
		super();
	}

	public FlashLightToggleController(Context context, INotificationToggle toggle) {
	...
	public String getLabel() {
		String label = null;
		label = mContext.getResources().getString(R.string.flash_light_toggle_label);
		return label;
	}

	@Override
	public Drawable getIconDrawable() {
			return mContext.getResources().getDrawable(R.drawable.ic_flash_light_toggle);
	}
