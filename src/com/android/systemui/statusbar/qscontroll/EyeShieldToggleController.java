...
public class EyeShieldToggleController extends NotificationToggleController
{

	public final static String TYPE = "EyeShieldToggleController";
	public EyeShieldToggleController() {
		super();
	}

	public EyeShieldToggleController(Context context, INotificationToggle toggle) {
	...
	public String getLabel() {
		String label = null;
		label = mContext.getResources().getString(R.string.eyeshield_toggle_label);
		return label;
	}

	@Override
	public Drawable getIconDrawable() {
			return mContext.getResources().getDrawable(R.drawable.ic_eyeshield_toggle);
	}
