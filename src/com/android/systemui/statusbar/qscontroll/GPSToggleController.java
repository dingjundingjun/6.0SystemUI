...
public class GPSToggleController extends NotificationToggleController
{

	public final static String TYPE = "GPSToggleController";
	public GPSToggleController() {
		super();
	}

	public GPSToggleController(Context context, INotificationToggle toggle) {
	...
	public String getLabel() {
		String label = null;
		label = mContext.getResources().getString(R.string.gps_toggle_label);
		return label;
	}

	@Override
	public Drawable getIconDrawable() {
			return mContext.getResources().getDrawable(R.drawable.ic_gps_toggle);
	}
