...
public class SuperPowerToggleController extends NotificationToggleController
{

	public final static String TYPE = "SuperPowerToggleController";
	public SuperPowerToggleController() {
		super();
	}

	public SuperPowerToggleController(Context context, INotificationToggle toggle) {
	...
	public String getLabel() {
		String label = null;
		label = mContext.getResources().getString(R.string.super_power_toggle_label);
		return label;
	}

	@Override
	public Drawable getIconDrawable() {
			return mContext.getResources().getDrawable(R.drawable.ic_super_power_toggle);
	}
