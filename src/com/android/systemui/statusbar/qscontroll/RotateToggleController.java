...
public class RotateToggleController extends NotificationToggleController
{

	public final static String TYPE = "RotateToggleController";
	public RotateToggleController() {
		super();
	}

	public RotateToggleController(Context context, INotificationToggle toggle) {
	...
	public String getLabel() {
		String label = null;
		label = mContext.getResources().getString(R.string.rotate_toggle_label);
		return label;
	}

	@Override
	public Drawable getIconDrawable() {
			return mContext.getResources().getDrawable(R.drawable.ic_rotate_toggle);
	}
