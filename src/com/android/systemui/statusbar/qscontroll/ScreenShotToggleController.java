...
public class ScreenShotToggleController extends NotificationToggleController
{

	public final static String TYPE = "ScreenShotToggleController";
	public ScreenShotToggleController() {
		super();
	}

	public ScreenShotToggleController(Context context, INotificationToggle toggle) {
	...
	public String getLabel() {
		String label = null;
		label = mContext.getResources().getString(R.string.screen_shot_toggle_label);
		return label;
	}

	@Override
	public Drawable getIconDrawable() {
			return mContext.getResources().getDrawable(R.drawable.ic_screen_shot_toggle);
	}
